...
from mix_net.mix_net.src.full_transformer  import newMixNet2
...
class MixNetTrainer:
    ...
    def __init__(self, params: dict, net: newMixNet2):
...
if __name__ == "__main__":
    ...
    net_param_file = os.path.join(repo_path,"MOTION_PREDICTION-TEAM", "train/configs/mix_net/net_full_params.json")

    if args.test:
        trainer_param_file = os.path.join(
            repo_path,
            "MOTION_PREDICTION-TEAM",
